...
public class SimpleItemTodoHistoryTouchHelperCallback extends ItemTouchHelper.Callback {
    private ItemTouchHelperAdapter mAdapter;

    public SimpleItemTodoHistoryTouchHelperCallback(ItemTouchHelperAdapter adapter){
        mAdapter = adapter;
...
//        int swipeFlags = ItemTouchHelper.LEFT |ItemTouchHelper.RIGHT;
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        mAdapter.onItemAppear(viewHolder.getAdapterPosition());
    }
}
